        ...
        Collections.sort(list, new Comparator<Stock>() {
            ...
            { String name1 = (String) stock1.get("name");
                ...
                if (name1.compareTo(name2) == 0) {
                    ...
                    String date1 = dateFormat1.format(stock1.get("date")).toString();
                    String date2 = dateFormat2.format(stock2.get("date")).toString();
                    if (date1.compareTo(date2) == 0) {
                        Double change1 = stock1.getChange(); //возвращает выручку
                        Double change2 = stock2.getChange();
    ...
    public static class Stock extends HashMap {
        ...
        double getChange() {
            ...
            if (this.containsKey("open")) {
                change = (double) this.get("open") - (double) this.get("last");
            } else change = (double) this.get("change");
            return change;
