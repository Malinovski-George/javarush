...
public class Solution {
    ...
    public static final class Constants{
        ...
        static String SERVER_IS_NOT_ACCESSIBLE_FOR_NOW = "Server is not accessible for now.";
        static String USER_IS_NOT_AUTHORIZED = "User is not authorized.";
        static String USER_IS_BANNED = "User is banned.";
        static String ACCESS_IS_DENIED = "Access is denied.";
    }
