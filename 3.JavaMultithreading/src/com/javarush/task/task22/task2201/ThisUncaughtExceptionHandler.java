...
public class ThisUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    */
    ...
    protected String getFormattedStringForFirstThread(Thread t, Throwable e, String string) {
        String rezult = String.format(string,
                t.getName(),
    ...
    protected String getFormattedStringForOtherThread(Thread t, Throwable e, String string) {
        String rezult = String.format(string, e.getClass().getSimpleName(), e.getCause(), t.getName());

        return rezult;
    }

    protected String getFormattedStringForSecondThread(Thread t, Throwable e, String string) {
        String rezult = String.format(string, e.getCause(), e.getClass().getSimpleName(), t.getName());
        return rezult;
    }
}
